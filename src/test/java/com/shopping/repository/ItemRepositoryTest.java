...
class ItemRepositoryTest {
    ...
    public void createItemTest() {
        ...
        assertEquals("테스트 상품", item.getItemNm());
    }
    ...
    public void findByItemNmTest() {
        this.createItemList();
        List<Item> itemList = this.itemRepository.findByItemNm("테스트 상품1");
    ...
    public void findByItemNmOrItemDetailTest() {
        this.createItemList();
        List<Item> itemList = this.itemRepository.findByItemNmOrItemDetail("테스트 상품1", "테스트 상품 상세 설명5");
    ...
    public void findByPriceLessThanTest() {
        this.createItemList();
        List<Item> itemList = this.itemRepository.findByPriceLessThan(10005);
    ...
    public void findByPriceLessThanOrderByPriceDesc() {
        this.createItemList();
        List<Item> itemList = this.itemRepository.findByPriceLessThanOrderByPriceDesc(10005);
    ...
    public void queryDslTest2() {
        ...
        Page<Item> itemPagingResult = this.itemRepository.findAll(booleanBuilder, pageable);
